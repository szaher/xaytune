...
class TestStepReport:
    def test_create(self):
        step = StepReport(name="deduplicate", input_rows=100, output_rows=85, details={"exact_dupes": 10, "near_dupes": 5})
...
class TestPrepReport:
    def test_single_step(self):
        report = PrepReport(input_rows=100, output_rows=85, steps=[
    ...
    def test_multi_step(self):
        report = PrepReport(input_rows=1000, output_rows=500, steps=[
