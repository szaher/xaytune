# Architecture Review — 2026-09-20, pre-implementation

```yaml
baseline_commit: 9fb2720          # main, before any Phase 1 work landed
reviewed_at: 2026-09-20
superseded: true
superseded_by: ARCHITECTURE-REVIEW-NOTE.md
```

> **HISTORICAL. Do not use this file to plan work.**
>
> This was the pre-implementation review, written against a `main` where
> `xaytune/core/` did not exist, CI was red, and 27 tests were failing. All of
> that has since changed. Its findings about the *target* architecture remain
> sound; its findings about *the repository* are describing a tree that no
> longer exists.
>
> It is kept because the mapping in §1 — which existing module becomes what —
> is still the clearest statement of the migration, and because the reasoning
> that produced the Phase 1 file list is worth being able to check.
>
> For current state see `ARCHITECTURE-REVIEW-NOTE.md`.
